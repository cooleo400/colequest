  ...
  render() {
    const bio = (
      <div>
        ...
        <p>After recording at NYC's renowned Magic Shop studio, by Grammy award winning producer Steve Rosenthal, they released their debut album in late July. Having shared bills with acts such as Sierra Hull, Sarah Jaroz, Billy Strings & Don Julin, The Brothers Comatose, The Lil Smokies, Whiskey Shivers, Old Salt Union, The Lonely Heartstring Band, Willie Watson, Blind Boy Paxton and Michael Daves, sign up for the mailing list to catch there next show!</p>
      </div>
    );
    const twitter = (
      <div>
